...
<title><?php echo $title; ?></title>
  ...
  <link rel="canonical" href="https://luvo.dev/<?php echo $mainpage; ?>"/>
...
<div class="main">
  ...
  <div class="header">
    ...
    <form class="login" action="profile_management/authenticate.php" method="post">
      ...
      <?php
        if (isset($_GET["newpassword"])) {
          if ($_GET["newpassword"] == "updatesuccess") {
            echo '<p class="signupsuccess">Your password has been reset!</p>';
          }
        }
       ?>
      <div class="forgot_account_link">
        <a href="reset-password.php">Forgot passoword?</a>
      </div>
      <div class="hr"></div>
